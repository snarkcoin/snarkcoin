...
"""Tests around snarkcoin governance objects."""
...
class SnarkcoinGovernanceTest (SnarkcoinTestFramework):
    def set_test_params(self):
        self.set_snarkcoin_test_params(2, 1)
