...
"""Verify that starting snarkcoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start snarkcoind with -h for help text")
        ...
        self.log.info("Start snarkcoind with -version for version information")
