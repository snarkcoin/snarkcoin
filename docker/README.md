...
official/supported Docker Images found at https://hub.docker.com/r/snarkcoinpay/snarkcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/snarkcoinpay/snarkcoind-develop/ when changing the above text**