 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1658178807, nBits=1e0ffff0, nNonce=1978760, vtx=1)
...
{
    const char* pszTimestamp = "July 18th 2022 Snarkcoin is created";
    const CScript genesisOutputScript = CScript() << ParseHex("04bbd5234696df968289d6307f49c7c13247610e523f43082164fe98909ed376ebde56bc5a7837b55920ac9e4da388bacad73caff89a4ca5da4ef3b610d720ea0c") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 96650; 
        ...
        consensus.defaultAssumeValid = uint256S("0x00000e25be16c4658aad2c41c1c875ecaf8af50171490e1aadadf92823b5de86"); 
        ...
        genesis = CreateGenesisBlock(1658178807, 1978760, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000e25be16c4658aad2c41c1c875ecaf8af50171490e1aadadf92823b5de86"));
        assert(genesis.hashMerkleRoot == uint256S("0x0fa38314d57424ef6fcf7e3362e2423a9277e8dca7074db2c03ca29e11d05606"));
        ...
        vSeeds.emplace_back("140.82.18.127");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,63);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,64);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,191);
        // Snarkcoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Snarkcoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Snarkcoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"SXKjS47gjG5x66GEw6nnVsH2h1LNqgtN4X"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x00000e25be16c4658aad2c41c1c875ecaf8af50171490e1aadadf92823b5de86")},
            }
        };

        chainTxData = ChainTxData{
            1658178807, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000003d84c61108b00e1cc310e984e0610221dee89c8336215f4d944a4bc0e7f"); 
        ...
        genesis = CreateGenesisBlock(1658178812UL, 1163623UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000003d84c61108b00e1cc310e984e0610221dee89c8336215f4d944a4bc0e7f"));
        assert(genesis.hashMerkleRoot == uint256S("0x0fa38314d57424ef6fcf7e3362e2423a9277e8dca7074db2c03ca29e11d05606"));
        ...
        // Testnet Snarkcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Snarkcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        ...
        vSporkAddresses = {"TB2R5DnUjvr3xCbaDWrydW6s65Qi4qbNCr"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x000003d84c61108b00e1cc310e984e0610221dee89c8336215f4d944a4bc0e7f")},
            }
        };

        chainTxData = ChainTxData{
            1658178812, // * UNIX timestamp of last known number of transactions
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1658178817, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x498aabebeea6a978ddf0dd75badceec2748ccc39ec458059acd2c7cb12fabef1"));
        assert(genesis.hashMerkleRoot == uint256S("0x0fa38314d57424ef6fcf7e3362e2423a9277e8dca7074db2c03ca29e11d05606"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x498aabebeea6a978ddf0dd75badceec2748ccc39ec458059acd2c7cb12fabef1")},
...
public:
    CRegTestParams() {
        ...
        // privKey: 7Voaues78aEEhRapr9oJRbSRM4jPVAiKv44Wi8dzaqqTob9rxt2
        vSporkAddresses = {"TPm6nGEibVoWJS4TgPCDLy3TqSAo77oUjy"};
        nMinSporkKeys = 1;
        ...
        // Regtest Snarkcoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest Snarkcoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest Snarkcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Snarkcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Snarkcoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
