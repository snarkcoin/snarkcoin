...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf("%s snarkcoin-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  snarkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded snarkcoin transaction\n" +
              "  snarkcoin-tx [options] -create [commands]   Create hex-encoded snarkcoin transaction\n" +
              "\n";
