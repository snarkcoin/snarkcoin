...
//! Interface for the src/evo part of a snarkcoin node (snarkcoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a snarkcoin node (snarkcoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a snarkcoin node (snarkcoind process).
...
//! Top-level interface for a snarkcoin node (snarkcoind process).
class Node
{
public:
    virtual ~Node() {}
