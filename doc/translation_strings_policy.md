...
This document provides guidelines for internationalization of the Snarkcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `snarkcoin_en.ts` remains unchanged.
