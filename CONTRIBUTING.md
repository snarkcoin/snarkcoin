...
[Translation Process](https://github.com/snarkcoinpay/snarkcoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Snarkcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Snarkcoin
...
The review process is normally fairly responsive on the Snarkcoin Core repository, however
