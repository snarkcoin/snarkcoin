...
Arguments:
    <base_directory> - The base directory of a Snarkcoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Snarkcoin Core developers'
...
Arguments:
    <base_directory> - The base directory of Snarkcoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Snarkcoin Core repository.
"""
